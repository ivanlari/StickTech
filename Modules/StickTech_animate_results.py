def animate_outputs(solver_outputs, plots_inputs_list, selected_result, inputs_list):
    ...
    if selected_result == "Longitudinal \nDynamics":
        ...
        print("\n" + datetime.now().strftime("%d/%m/%Y %H:%M:%S") + "    Generating Animation for the Longitudinal Dynamics. It may take some time...")
        ...
        #plt.show()
        print("\n" + datetime.now().strftime("%d/%m/%Y %H:%M:%S") + "    Animation has been saved.")
        ...
        print("\n" + datetime.now().strftime("%d/%m/%Y %H:%M:%S") + "    Generating Animation for the Lateral-Directional Dynamics. It may take some time...")
        ...
        print("\n" + datetime.now().strftime("%d/%m/%Y %H:%M:%S") + "    No Animation is available for this output.")
        logging.info(datetime.now().strftime("%d/%m/%Y %H:%M:%S") + "    No Animation is available for this output.")
    else:
        print("\n" + datetime.now().strftime("%d/%m/%Y %H:%M:%S") + "    Select a Result to generate an Animation.")
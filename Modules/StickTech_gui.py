def LADS_GUI(code_name, code_build, root):
    ...
    root.geometry("940x755")
    root['background']=back_color
    
    Titolo1 = Label(root, text=" ", font=("Arial", 15))
    Titolo1.config(bg=back_color)
    Titolo1.grid(row=0, column=1)

    Titolo2 = Label(root, text="LONGITUDINAL", font=("Arial", 13))
    Titolo2.config(bg=back_color)
    Titolo2.grid(row=1, column=1)
    Titolo3 = Label(root, text="DERIVATIVES", font=("Arial", 13))
    Titolo3.config(bg=back_color)
    Titolo3.grid(row=1, column=2)

    Titolo4 = Label(root, text="                          LATERAL", font=("Arial", 13))
    Titolo4.config(bg=back_color)
    Titolo4.grid(row=1, column=3)
    Titolo5 = Label(root, text="DERIVATIVES", font=("Arial", 13))
    ...
    testo1 = Label(root, text="Xu [1/s]: ", font=("Arial", 12, 'italic'))
    testo1.grid(row=2, column=1)
    testo1.config(bg=back_color)
    e1 = Entry(root, borderwidth=2)
    e1.grid(row=2, column=2)
    e1.insert(0, -0.013)

    testo2 = Label(root, text="Zu [1/s]: ", font=("Arial", 12, 'italic'))
    testo2.grid(row=3, column=1)
    testo2.config(bg=back_color)
    e2 = Entry(root, borderwidth=2)
    e2.grid(row=3, column=2)
    e2.insert(0, -0.1)

    testo3 = Label(root, text="Mu [1/(m*s)]: ", font=("Arial", 12, 'italic'))
    testo3.grid(row=4, column=1)
    testo3.config(bg=back_color)
    e3 = Entry(root, borderwidth=2)
    e3.grid(row=4, column=2)
    e3.insert(0, -0.0001)

    testo4 = Label(root, text="Xw [1/s]: ", font=("Arial", 12, 'italic'))
    testo4.grid(row=5, column=1)
    testo4.config(bg=back_color)
    e4 = Entry(root, borderwidth=2)
    e4.grid(row=5, column=2)
    e4.insert(0, 0.0482)

    testo5 = Label(root, text="Zw [1/s]: ", font=("Arial", 12, 'italic'))
    testo5.grid(row=6, column=1)
    testo5.config(bg=back_color)
    e5 = Entry(root, borderwidth=2)
    e5.grid(row=6, column=2)
    e5.insert(0, -0.539)

    testo6 = Label(root, text="Mw [1/(m*s)]: ", font=("Arial", 12, 'italic'))
    testo6.grid(row=7, column=1)
    testo6.config(bg=back_color)
    e6 = Entry(root, borderwidth=2)
    ...
    testo7 = Label(root, text="Zq [m/(rad*s)]: ", font=("Arial", 12, 'italic'))
    #testo7.grid(row=8, column=1)
    testo7.config(bg=back_color)
    e7 = Entry(root, borderwidth=2)
    #e7.grid(row=8, column=2)
    ...
    GUI_outputs_1 = [e1, e2, 
        ...
        e24, e25, e26, e27, e30, e34, e38, e31, e35, e39, e32, e36, e40, e28]
    
    GUI_outputs_2 = [e43, e44, e45, e46, e47, e48, e49, e50, e51, e52, e53, e54]

    return GUI_outputs_1, GUI_outputs_2, variable_option_menu, variable_option_menu_2, variable_option_menu_3
def StepTech(tf_outputs, selected_tf):
    ...
    if selected_tf == "Select a TF":
        print("\nSelect a Transfer Function to be put in Closed Loop.")
    ...
    if tf_marker == True: # Start Tuner
        ...
        print("Starting StepTech Tuner...")

        # Plots
        fig = plt.figure("StepTech 1.0", figsize=(9, 6))
        plt.subplots_adjust(bottom=0.4)
        ax = fig.subplots()
        plt.suptitle("PID Tuner - Transfer Function: " + tf_name, fontsize=13)
        ...
        text_wpc = fig.text(0.65, 0.17, 'Phase Crossover freq. (rad/s): ' + f'{wpc:.1f}', fontsize = 10, color = "black")

        text_wgc = fig.text(0.65, 0.13, 'Gain Crossover freq. (rad/s): ' + f'{wgc:.1f}', fontsize = 10, color = "black")

def plot_viewer(selected_plot, selected_tf, tf_outputs):
    ...
    if selected_tf == "Select a TF":
        ...
        if selected_plot == "Select a Plot":
            ...
            plt.suptitle("Bode Plot for Transfer Function: " + selected_tf, fontsize=12)  # Titolo personalizzato
            plt.show()
            plt.close(fig_bode)
            ...
            plt.suptitle("Root Locus for Transfer Function: " + selected_tf, fontsize=12)  # Titolo personalizzato
            plt.show()
            plt.close(fig_rl)
            ...
            plt.suptitle("Nyquist Plot for Transfer Function: " + selected_tf, fontsize=12)  # Titolo personalizzato
            plt.show()
            plt.close(fig_nyq)
        else:
            pass
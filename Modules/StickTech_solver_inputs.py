def inputs(GUI_outputs_1):
    ...
    eT1 = GUI_outputs_1[34]
    eT2 = GUI_outputs_1[35]
    eT3 = GUI_outputs_1[36]
    ...
    dt     = 0                      # spinta (kg, 2% del peso) --> PREDISPOSIZIONE
    ...
    t_t = 0                         # Istante in cui arriva il comando di spinta (s) --> PREDISPOSIZIONE
    ...
    tau_t = 0                       # Durata del comando di spinta (s) --> PREDISPOSIZIONE
    ...
    # Comando di spinta (gradino finito) --> PREDISPOSIZIONE
    thrust = lambda x: 1 if x == t_t else 0 if x < t_t else 0 if x > t_t+tau_t else 1
    ...
    inputs_list = [Xu, Xw, g, Zu, Zw, Zde, de, U0, Mu, Mw, Mw_dot, Mq, Mde, equilibratore, 
        ...
        de_deg, t_r, tau_r, dr_deg, t_a, tau_a, da_deg, Xdt, Zdt, Mdt, t_t, tau_t, dt, thrust]
    
    plots_inputs_list = [t_e, tau_e, de_deg, t_r, tau_r, dr_deg, t_a, tau_a, da_deg, t_t, tau_t, dt]

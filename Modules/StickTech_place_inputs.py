def place_inputs(gui_list_trim_load, GUI_outputs_1, GUI_outputs_2):
    ...
    if os.path.isfile("GUI_Inputs.txt"):
        ...
        e28.delete(0, tk.END)
        e28.insert(0, gui_list_trim_load[6])

        e43.delete(0, tk.END)
        e43.insert(0, gui_list_trim_load[35])

        e44.delete(0, tk.END)
        e44.insert(0, gui_list_trim_load[36])

        e45.delete(0, tk.END)
        e45.insert(0, gui_list_trim_load[37])

        e46.delete(0, tk.END)
        e46.insert(0, gui_list_trim_load[38])

        e47.delete(0, tk.END)
        e47.insert(0, gui_list_trim_load[39])

        e48.delete(0, tk.END)
        e48.insert(0, gui_list_trim_load[40])

        e49.delete(0, tk.END)
        e49.insert(0, gui_list_trim_load[41])

        e50.delete(0, tk.END)
        e50.insert(0, gui_list_trim_load[42])

        e51.delete(0, tk.END)
        e51.insert(0, gui_list_trim_load[43])

        e52.delete(0, tk.END)
        e52.insert(0, gui_list_trim_load[44])

        e53.delete(0, tk.END)
        e53.insert(0, gui_list_trim_load[45])

        e54.delete(0, tk.END)
        e54.insert(0, gui_list_trim_load[46])
        ...
        #                     Nda_apice, Ndr_apice, t_e, tau_e, de_deg, t_r, tau_r, dr_deg, t_a, tau_a, da_deg (34), u0, 
        #                     w0, q0, Theta0, h0, Beta0, p0, r0, phi0, psi0, Tmax, DeltaT (46)]

        print("\n" + datetime.now().strftime("%d/%m/%Y %H:%M:%S") + "    Inputs correctly loaded.")
        logging.info(datetime.now().strftime("%d/%m/%Y %H:%M:%S") + "    Inputs correctly loaded.")

__author__      = "Ivan Lari"
__copyright__   = "None"
__license__     = "GPL"
__version__     = "1.0.0"
__maintainer__  = "Ivan Lari"
__email__       = "ivanlari@outlook.it"
...
GUI_outputs_1, GUI_outputs_2, variable_option_menu, variable_option_menu_2, variable_option_menu_3 = LADS_GUI(code_name, code_build, root)
...
def Solve_OL():
    ...
    plots(solver_outputs, plots_inputs_list, dynamics_outputs)
...
def Solve_CL():
    ...
    StepTech(tf_outputs, selected_tf)

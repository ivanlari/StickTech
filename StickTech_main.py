...
from Modules import StickTech_EulerAnimation, outputs, plots, solver_model, inputs, header, LADS_GUI, footer, print_tf, compute_tf
from Modules import StepTech, results_viewer, plot_viewer, save_inputs, load_inputs, place_inputs
from Modules import animate_outputs, quitRoot, openWD, eulAnim, mergeAnim, computeTrajectory, runRT
...
def Solve_OL():
    ...
    solver_outputs, initial_conditions, delta_X0 = solver_model(inputs_list, GUI_outputs_2)
...
def AnimateResults():
    ...
    animate_outputs(solver_outputs, plots_inputs_list, inputs_list)
    eulAnim(solver_outputs, inputs_list)
    mergeAnim()
...
def Trajectory():
    ...
    # ------------------------------------- Run Compute Trajectory --------------------------------

    computeTrajectory(solver_outputs, inputs_list)
...
def StickTechRT():
    ...
    runRT(inputs_list, GUI_outputs_2, code_build)
